...
include_once(_PS_MODULE_DIR_.'pg_prestashop_plugin/classes/WebserviceSpecificManagementGpvicommWebhook.php');

const FLAVOR = 'GpViComm';
const FLAVOR_DOMAIN = 'gpvicomm.com';
const REFUND_PATH = '/v2/transaction/refund/';

/**
 * PG_Prestashop_Plugin - A Payment Module for PrestaShop 1.7.7
 * @author Gpvicomm Development <dev@gpvicomm.com>
...
class PG_Prestashop_Plugin extends PaymentModule
{
    public function __construct()
    {
        ...
        $this->bootstrap              = true;
        $this->displayName            = 'Pago con Tarjeta'.'('.FLAVOR.')';
